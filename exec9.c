...
char* exec9_c1_func(char* arr) {
	...
	arr2 = (char*)calloc((size*2)+1, sizeof(char));
	assert(arr2);
	strcat(arr2, arr);
	strcat(arr2, arr);	
	return arr2;
...
int exec9_c1() {
	char arr[50] = {"abc"}, *arr2;
	arr2 = exec9_c1_func(arr);
	puts(arr);
	puts(arr2);
	free(arr2);
	return 0;
...
int exec9_c2() {
	char ar[50] = { "strings seem silly" }, res;
	int amount = 19;
	res = exec9_c2_func(ar, &amount);
	puts(ar);
	printf("the most recent character was: %c(X%d)", res, amount);
	return 0;
}
//c3
int exec9_c3() {
	int arr[7] = { 1,6,3,3,6,3,3 },i, times = 0;
	i = exec9_c3_func(arr, 7, &times);
...
int exec9_c4() {
	...
	printf("res: %d\n", exec9_c4_func(arr, num, k));
	printf("res 2: %d\n", exec9_c4_func(arr2, num, k));
	return 0;
}
//c5
...
int exec9_c5() {
	...
	printf("res: %d\n", exec9_c5_func(arr, n, a, b));
	a = 1;
	b = 9;
	n = 6;
	printf("res 2: %d\n", exec9_c5_func(arr2, n, a, b));
	return 0;
}
//*--*--*--*---*--*--*--*--*--*--*--*home*--*--*--*--*--*--*--*--*--*--*//
//h1
